	...
	templates = [
		{
			...
			"blanks": [
				...
				{"type": "adjective", "hint": "describe the goblin's speed (blazing? suspicious? baffling?)", "display": "ADJECTIVE"},
			]
		},
		{
		...
		},
		{
			...
			"blanks": [
				{"type": "adjective", "hint": "what kind of ambush? (planned? accidental? chaotic?)", "display": "ADJECTIVE"},
				{"type": "verb",      "hint": "how did the hero move through it? (sprint? crawl? dance?)",      "display": "VERB"},
				{"type": "adjective", "hint": "describe the arrow storm (relentless? sparse?)",    "display": "ADJECTIVE"},
			]
		},
		{
			...
			"blanks": [
				...
				{"type": "adjective", "hint": "describe the roar (thunderous? squeaky?)",         "display": "ADJECTIVE"},
		...
		},
		{
			...
			"blanks": [
				{"type": "adjective", "hint": "describe the goblin's ally (hulking? tiny? enthusiastic?)", "display": "ADJECTIVE"},
				{"type": "adjective", "hint": "describe the net (heavy? fraying? clean?)",         "display": "ADJECTIVE"},
		...
		},
		{
			...
			"blanks": [
				{"type": "adjective", "hint": "what kind of last stand? (valiant? desperate? short?)",    "display": "ADJECTIVE"},
				{"type": "adjective", "hint": "how desperate was that leap? (reckless? frantic? graceful?)", "display": "ADJECTIVE"},
