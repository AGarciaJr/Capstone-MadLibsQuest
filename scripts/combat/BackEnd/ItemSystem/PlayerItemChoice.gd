...
@onready var choice_1_icon: TextureRect = $ItemNodeOriginContainer/DetailsRow/ItemChoice1/ItemIcon
...
@onready var choice_2_icon: TextureRect = $ItemNodeOriginContainer/DetailsRow/ItemChoice2/ItemIcon
...
@onready var choice_3_icon: TextureRect = $ItemNodeOriginContainer/DetailsRow/ItemChoice3/ItemIcon
...
func set_items(items: Array) -> void:
	...
	var icons: Array[TextureRect] = [choice_1_icon, choice_2_icon, choice_3_icon]
	...
	for i in range(3):
		if i < items.size():
			...
			var icon_path: String = String(it.get("icon", ""))
			icons[i].texture = load(icon_path) if icon_path != "" else null
